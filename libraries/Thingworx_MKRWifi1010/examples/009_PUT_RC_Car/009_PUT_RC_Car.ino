...
//    ... ask for user data.
    ...
    Serial.println("Insert AppKey:");
    String AppKey = Serial.readStringUntil('\n');
    Serial.println("Insert TWX-Server:");
    ...
    AppKey.toCharArray(settings.AppKey, AppKey.length()+2);
    Server.toCharArray(settings.Server, Server.length()+2);
    ...
    Serial.print("AppKey:  "); Serial.println(settings.AppKey);
...
//******************************************************* SENDING DATA TO THINGWORX  *******************************************************************
  ...
  {  
    ...
    myThing.put_many(send_values,sizearray);      //Send values to server platform
