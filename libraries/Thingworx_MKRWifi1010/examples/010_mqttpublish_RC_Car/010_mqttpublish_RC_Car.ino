...
//    ... ask for user data.
    ...
    Serial.print("Broker:  "); Serial.println(settings.Broker);
    Serial.print("Port:    "); Serial.println(settings.Port);
    Serial.print("Topic:    "); Serial.println(settings.Topic);
    Serial.print("SSID:    "); Serial.println(settings.SSID);
    Serial.print("WifiPWD: "); Serial.println(settings.WifiPWD);
    Serial.println("\n\n To change settings press the SETUP button at boottime");
...
//******************************************************* THINGWORX SETUP **************************************************
//**************************************************************************************************************************************************
ThingWorx_MQTT myThing(settings.Broker, settings.Port, settings.Topic, settings.SSID, settings.WifiPWD);  //Define Thingworx Class (1 per Thing) 
...
//******************************************************* SENDING DATA TO THINGWORX  *******************************************************************
  ...
  //{  
    setLEDColor(0,0,255);                         // turn LED to blue
    myThing.mqtt_publish(String(sens_dht_temp),100);      //Send values to server platform
