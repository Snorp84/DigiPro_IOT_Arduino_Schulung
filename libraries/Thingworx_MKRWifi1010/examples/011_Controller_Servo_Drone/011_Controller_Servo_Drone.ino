...
#define PIN_JOY_Z        PIN_A3         // PIN of Joystick 2 for z-Axis of drone
...
char mqttData [300];
String property_list[]={"Servo1","Servo2","Servo3","links","rechts","oben","unten","mittig","rauf","runter"};
String mqtt_sub;
String mqtt_pub;
...
if (currentMillis - MQTT_previousMillis >= MQTT_intervall) {
    ...
    float send_values[]={position_servo1,position_servo2,position_servo3,joy_links,joy_rechts,joy_oben,joy_unten,joy_mittig,joy_rauf,joy_runter};
